...
export function EyeOffIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c6.5 0 10 7 10 7a18.82 18.82 0 0 1-4.07 5.22" />
      <path d="M6.12 6.12A18.82 18.82 0 0 0 2 12s3.5 7 10 7a10.94 10.94 0 0 0 2.76-.36" />
      <path d="m2 2 20 20" />
